        ...
        <Box sx={{ mx: {xs: 5, lg:15}, my:{xs: 3, lg:4} }}>
            ...
            <Stack spacing={{ xs: 2, sm: 6 }} direction="row" useFlexGap flexWrap="wrap" sx={{ justifyContent: "center", py: "20px", }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", flexDirection:{xs: "column", lg:"row"} }}>
                    <Typography sx={{ color: "#9099AB", fontSize: {xs: "18px", md: "20px"}, width: {xs: "100%", lg: "70%"},textAlign:"justify" }}>Brushing your teeth twice daily with fluoride toothpaste helps prevent plaque buildup and cavities.</Typography>
