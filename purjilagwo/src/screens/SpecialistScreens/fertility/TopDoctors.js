...
const TopDoctors = () => {
    return (
        <Box sx={{ mx: { xs: 5, lg: 15 }, my: { xs: 3, lg: 4 } }}>
            ...
            <Stack spacing={{ xs: 2, sm: 6 }} direction="row" useFlexGap flexWrap="wrap" sx={{ justifyContent: "center", py: "20px", }}>
                <Typography sx={{ fontSize: { xs: "24px", lg: "40px" }, fontWeight: 600, color: "#1C4188" }}>
                    Top Fertility Specialist
                </Typography>
                <Container>
                    <Box sx={{ display: "flex", justifyContent: "space-between", flexDirection: { xs: "column", lg: "row" } }}>
                        <Typography sx={{ color: "#9099AB", fontSize: { xs: "18px", md: "20px" }, width: { xs: "100%", lg: "70%" }, textAlign: "justify" }}>A comprehensive eye care routine involves regular check-ups, healthy lifestyle choices, and protective measures to safeguard against potential hazards.</Typography>
