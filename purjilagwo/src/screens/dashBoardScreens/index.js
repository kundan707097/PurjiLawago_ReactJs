        ...
        <>
            <Box sx={{display: "flex", bgcolor:"#F8FCFB"}}>
                ...
                <Routes>
                    ...
                    {(localStorage.getItem("role") === "Patient" && localStorage.getItem("isDocotrsOrPatiets") === "false") && (<Route exact path="/appointment&details" element={<PateintAppointmentDashboard />} />)}
